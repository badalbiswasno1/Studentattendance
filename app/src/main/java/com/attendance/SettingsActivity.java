    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSetTime.setOnClickListener(v -> {
            ...
            new TimePickerDialog(this, (tp, hour, min) -> {
                ...
                Toast.makeText(this, "Time set: " + hour + ":" + String.format("%02d", min), Toast.LENGTH_SHORT).show();
            }, h, m, true).show();
        });
        ...
        btnBackup.setOnClickListener(v ->
            Toast.makeText(this, "All data stored locally. Uninstalling will erase data. Use PDF export to save records.", Toast.LENGTH_LONG).show());
    }
}
